...
async function handleSignup(value: FieldType){
...
const Signup = ({setToken, setIsLoginPage}) => {
    ...
    <Card title="注册" style={{ width: 500 }}>
      ...
      >
        ...
        <Form.Item<FieldType>
          ...
          name="name"
          initialValue={'阿坤'}
          rules={[{ required: true, message: '请输入姓名!', pattern: /^[^0-9]{2,}$/ }]}
        >
          <Input />
        </Form.Item>
        ...
        <Form.Item wrapperCol={{ offset: 8, span: 16 }} style={{marginTop: 30}}>
          ...
          <Button type="dashed" style={{marginLeft: '10%'}} onClick={()=>setIsLoginPage(true)}>
            登录
          </Button>
        </Form.Item>
